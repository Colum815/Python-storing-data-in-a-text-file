...
def add_band():
    ...
    bands_module_text_file.band_info(band, album, producer)


def show_band():
    bands = bands_module_text_file.list_band_info()
    for band in bands:
        print(
...
def heard_album():
    ...
    bands_module_text_file.listened_to_album_info(user_album)


def delete_band():
    band = input("Enter a band to delete ")
    bands_module_text_file.delete_band_info(band)
